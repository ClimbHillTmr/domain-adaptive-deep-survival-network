...
A total of 291,828 dialysis sessions were included in the final analysis, comprising 216,604 sessions from the Shenyi development cohort and 75,224 sessions from the Fuding external validation cohort. The Fuding cohort contained 430 unique patients and was split at the patient level into a target updating subset (146 patients; 25,907 sessions), a target validation subset (26 patients; 4,569 sessions), and a held-out test subset (258 patients; 44,702 sessions). Patient overlap across the three target subsets was 0 for all pairwise comparisons (Fig. 1).
